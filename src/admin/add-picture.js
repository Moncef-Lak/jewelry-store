        ...
        <div className='in-add-admin'>
          ...
          <section className='right-side'>
            <form onSubmit={handleSubmit(handleSubmit2)} >
                ...
                <div className='radio-box'>
                  <h3>favourite</h3> 
                 <div className='radio-in'><input type="radio" required {...register('favorit', { required: true })} value="Yes"></input> Yes </div>
                 <div className='radio-in'><input type="radio" required {...register('favorit', { required: true })} value="No" /> No</div>
                </div>
                {errors.favorit && errors.favorit.type === 'required' && (<p><BiError/> This is Required</p>)}
            ...
            <Link to='/gallery'><h2>Return to Gallery <AiOutlineArrowRight className='aroow-right'/></h2></Link>
          </section>
        </div>
      </section>
    </>
