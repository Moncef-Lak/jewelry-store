...
const UpdateBijoux = () => {
  ...
  const handleSubmit2 = (data) => {
    ...
    myObj.append(
      "description",
      data.description ? data.description : BijouxItem[0].description
    );
    myObj.append(
      "image",
      data.imageName[0] ? data.imageName[0] : BijouxItem[0].image_name
    );
    myObj.append(
      "back_image",
      data.backImageName[0] ? data.backImageName[0] : BijouxItem[0].image_name2
    );
          ...
          <section className="right-side">
            ...
            >
              ...
              <div className="list-before-box">
                ...
                <h4>
                  {BijouxItem[0] &&
                    (BijouxItem[0].description.length > 20
                      ? BijouxItem[0].description.substring(0, 20) + "..."
                      : BijouxItem[0].description)}
                </h4>
              </div>
              <div className="list-before-box">
                <h2>Price :</h2>
            ...
            <form onSubmit={handleSubmit(handleSubmit2)}>
              ...
              <input
                ...
                onChange={(e) =>
                  setValue("backImageName", e.target.value.files)
                }
                {...register("backImageName", {
                  required: false,
                  validate: (value) => {
                    if (value[0]) {
                      return (
              ...
              {errors.backImageName &&
                errors.backImageName.type === "validate" && (
                  <p>
                    <BiError /> Size must Be at the most 0.5 Mo
                  </p>
                )}
            ...
            <Link to="/bijoux">
              <h2>
                Return to Store <AiOutlineArrowRight className="aroow-right" />
              </h2>
            </Link>
          </section>
        </div>
